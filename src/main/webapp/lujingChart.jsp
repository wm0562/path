	...
	<div id="page">
		...
		<div class="ant-layout">
			...
			<input type="button" name="submit" id="searchid" value="搜索">
  			...
  			<table id="chartData">
    		<tr style="color: #49469C">
     		<td>入径病人</td><td id="ljtjId">6</td>
    		</tr>

    		<tr style="color: #6A6A49">
      		<td>出径病人</td><td id="pathId">2</td>
    		</tr>

    	    <tr style="color: #082E54">
      		<td>路径超时</td><td id="cname">4</td>
    		</tr>
    
    		<tr style="color: #802A2A">
      		<td>路径变异</td><td id="rjbr">1</td>
    		</tr>
    
    		<tr style="color: #D2691E">
      		<td>路径完成</td><td id="ljcs">2</td>
    		</tr>
    
    		<tr style="color: #292421">
      		<td>路径逃逸</td><td id="cjbr">0</td>
   			</tr>
  			</table>
			</div>
     </div>
