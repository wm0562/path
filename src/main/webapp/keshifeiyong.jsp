       ...
       <div>
        <div class="wp-content___1AXIT" style="height: 90vh;">
         ...
         <div style="display: flex; align-items: center; margin-bottom: 10px; margin-left: -10px;">
          ...
          <span>科室费用详细信息</span><!-- 
          <span style="margin-left: 40px;">20</span> -->
         </div>
              ...
              <form class="ant-form ant-form-inline">
               ...
               <div class="text-show___3oERO" style="display: flex; flex-wrap: wrap;">    
                ...
                <div class="disableVisble___1_Bdv">
                 <div class="ant-row ant-form-item">
                  <div class="ant-form-item-label">
                   <label for="cdepartment" class="" title="科室">科室</label>
                  </div>
                  <div class="ant-form-item-control-wrapper">
                   <div class="ant-form-item-control">
                    <span class="ant-form-item-children">
                     <div value="" id="cdepartment" name="cdepartment" data-__meta="[object Object]" data-__field="[object Object]">
                ...
                <div class="disableVisble___1_Bdv">
                 <div class="ant-row ant-form-item">
                  <div class="ant-form-item-label">
                   <label for="depart_fee" class="" title="就诊费用">就诊费用</label>
                  </div>
                  <div class="ant-form-item-control-wrapper">
                   <div class="ant-form-item-control has-success">
                    <span class="ant-form-item-children">
                     <div value="就诊费用" id="depart_fee" name="depart_fee" data-__meta="[object Object]" data-__field="[object Object]">
...
$(window).load(function() {
 ...
 //查询
  $(document).on("click","#searchid",function(){
	  ...
	  getDepartmentFee(mid);
  });
//获取收藏加载的数据
function getDepartmentFee(mid){
	$.ajax({
		url:"http://localhost:8080/path/getDepartmentFee",
		type:"get",
		data:"mid="+mid,
		success:function(result){
			 var item=result.extend.pageInfo.list;
				...
				$("#cdepartment").html(item[0].cdepartment);
				$("#depart_fee").html(item[0].depart_fee);
		}
		});
