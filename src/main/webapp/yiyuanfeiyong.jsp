       ...
       <div>
        <div class="wp-content___1AXIT" style="height: 90vh;">
         ...
         <div style="display: flex; align-items: center; margin-bottom: 10px; margin-left: -10px;">
          ...
          <span>医院费用详细信息</span><!-- 
          <span style="margin-left: 40px;">5</span> -->
         </div>
              ...
              <form class="ant-form ant-form-inline">
               ...
               <div class="text-show___3oERO" style="display: flex; flex-wrap: wrap;">    
                ...
                <div class="disableVisble___1_Bdv">
                 <div class="ant-row ant-form-item">
                  <div class="ant-form-item-label">
                   <label for="ope_cost" class="" title="手术费用">手术费用</label>
                  </div>
                  <div class="ant-form-item-control-wrapper">
                   <div class="ant-form-item-control">
                    <span class="ant-form-item-children">
                     <div value="手术费用" id="ope_cost" name="ope_cost" data-__meta="[object Object]" data-__field="[object Object]">
                ...
                <div class="disableVisble___1_Bdv">
                 <div class="ant-row ant-form-item">
                  <div class="ant-form-item-label">
                   <label for="post_cost" class="" title="术后康复期费用">术后康复期费用</label>
                  </div>
                  <div class="ant-form-item-control-wrapper">
                   <div class="ant-form-item-control has-success">
                    <span class="ant-form-item-children">
                     <div value="术后康复期费用" id="post_cost" name="post_cost" data-__meta="[object Object]" data-__field="[object Object]">
                ...
                <div class="disableVisble___1_Bdv">
                 <div class="ant-row ant-form-item">
                  <div class="ant-form-item-label">
                   <label for="wait_cost" class="" title="住院等待日费用">住院等待日费用</label>
                  </div>
                  <div class="ant-form-item-control-wrapper">
                   <div class="ant-form-item-control">
                    <span class="ant-form-item-children">
                     <div value="住院等待日费用" id="wait_cost" name="wait_cost" data-__meta="[object Object]" data-__field="[object Object]">
                ...
                <div class="disableVisble___1_Bdv">
                 <div class="ant-row ant-form-item">
                  <div class="ant-form-item-label">
                   <label for="ave_med_cost" class="" title="平均医疗费用">平均医疗费用</label>
                  </div>
                  <div class="ant-form-item-control-wrapper">
                   <div class="ant-form-item-control">
                    <span class="ant-form-item-children">
                     <div value="平均医疗费用" id="ave_med_cost" name="ave_med_cost" data-__meta="[object Object]" data-__field="[object Object]">
                ...
                <div class="disableVisble___1_Bdv">
                 <div class="ant-row ant-form-item">
                  <div class="ant-form-item-label">
                   <label for="ave_drug_cost" class="" title="平均药品费用">平均药品费用</label>
                  </div>
                  <div class="ant-form-item-control-wrapper">
                   <div class="ant-form-item-control">
                    <span class="ant-form-item-children">
                     <div value="平均药品费用" id="ave_drug_cost" name="ave_drug_cost" data-__meta="[object Object]" data-__field="[object Object]">
                ...
                <div class="disableVisble___1_Bdv">
                 <div class="ant-row ant-form-item">
                  <div class="ant-form-item-label">
                   <label for="exp_reim" class="" title="病人费用报销">病人费用报销</label>
                  </div>
                  <div class="ant-form-item-control-wrapper">
                   <div class="ant-form-item-control">
                    <span class="ant-form-item-children">
                     <div value="病人费用报销" id="exp_reim" name="exp_reim" data-__meta="[object Object]" data-__field="[object Object]">
...
//获取收藏加载的数据
function getHospFee(mid){
	$.ajax({
		url:"http://localhost:8080/path/getHospFee",
		type:"get",
		data:"mid="+mid,
		success:function(result){
			 var item=result.extend.pageInfo.list;
				...
				$("#ope_cost").html(item[0].ope_cost);
				$("#post_cost").html(item[0].post_cost);
				$("#wait_cost").html(item[0].wait_cost);
				$("#ave_med_cost").html(item[0].ave_med_cost);
				$("#ave_drug_cost").html(item[0].ave_drug_cost);
				$("#exp_reim").html(item[0].exp_reim);
		}
		});
